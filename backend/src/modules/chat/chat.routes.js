...
router.post('/conversations/:id/messages', authenticate, validate(sendMessageSchema), chatController.sendMessage);
...
router.put('/conversations/:id/assign', authenticate, authorize(ROLES.ADMIN, ROLES.PHARMACIST), validate(assignConversationSchema), chatController.assignConversation);
router.put('/conversations/:id/unassign', authenticate, authorize(ROLES.ADMIN, ROLES.PHARMACIST), chatController.unassignConversation);

router.get('/inbox', authenticate, authorize(ROLES.ADMIN, ROLES.PHARMACIST), chatController.getMyInbox);
router.get('/open', authenticate, authorize(ROLES.ADMIN, ROLES.PHARMACIST), chatController.getOpenConversations);
