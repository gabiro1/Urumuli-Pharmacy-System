...
export function mapMedicine(medicine) {
  ...
  return {
    ...
    productType: medicine.product_type || 'MEDICINE',
    subcategory: medicine.subcategory || null,
    sku: medicine.sku || null,
    supplierId: medicine.supplier_id || null,
    supplierName: medicine.supplier_name || null,
    expiryDate: medicine.expiry_date || null,
    activeIngredients: medicine.active_ingredients || null,
    routeOfAdministration: medicine.route_of_administration || null,
    dosageInstructions: medicine.dosage_instructions || null,
    carePurpose: medicine.care_purpose || null,
    ingredients: medicine.ingredients || null,
    usageInstructions: medicine.usage_instructions || null,
    sizeDescription: medicine.size_description || null,
    isArchived: Boolean(medicine.is_archived),
